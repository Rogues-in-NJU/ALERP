...
export class UserManagementAddComponent implements ClosableTab, OnInit {
  ...
  authsTmp: userAuthVO[] = [
    ...
    <userAuthVO>{id: 4, authId: 9, description: "获取收款单详情", action: 0},
    <userAuthVO>{id: 5, authId: 10, description: "修改收款单截止日期", action: 0},
    <userAuthVO>{id: 6, authId: 11, description: "修改发票流水号", action: 0},
    <userAuthVO>{id: 7, authId: 12, description: "查询收款单列表", action: 0},
    <userAuthVO>{id: 8, authId: 13, description: "获取欠款统计列表", action: 0},
    <userAuthVO>{id: 9, authId: 14, description: "查看客户详细信息", action: 0},
    <userAuthVO>{id: 10, authId: 15, description: "删除客户", action: 0},
    <userAuthVO>{id: 11, authId: 16, description: "获取客户列表", action: 0},
    <userAuthVO>{id: 12, authId: 17, description: "新增客户/修改客户信息", action: 0},
    <userAuthVO>{id: 13, authId: 18, description: "新增公司支出", action: 0},
    <userAuthVO>{id: 14, authId: 19, description: "删除公司支出", action: 0},
    <userAuthVO>{id: 15, authId: 20, description: "获取公司支出列表", action: 0},
    <userAuthVO>{id: 16, authId: 21, description: "获取加工单列表", action: 0},
    <userAuthVO>{id: 17, authId: 22, description: "查询加工单详情", action: 0},
    <userAuthVO>{id: 18, authId: 23, description: "新增或者更新加工单", action: 0},
    <userAuthVO>{id: 19, authId: 24, description: "新增或者更新加工单商品", action: 0},
    <userAuthVO>{id: 20, authId: 25, description: "删除加工单商品", action: 0},
    <userAuthVO>{id: 21, authId: 26, description: "打印加工单", action: 0},
    ...
    <userAuthVO>{id: 29, authId: 34, description: "增加收款记录", action: 0},
    <userAuthVO>{id: 30, authId: 35, description: "删除收款记录", action: 0},
    <userAuthVO>{id: 31, authId: 36, description: "删除出货单", action: 0},
    <userAuthVO>{id: 32, authId: 37, description: "获取出货单列表", action: 0},
    <userAuthVO>{id: 33, authId: 38, description: "新增出货单", action: 0},
    <userAuthVO>{id: 34, authId: 39, description: "查看出货单详情", action: 0},
    ...
    <userAuthVO>{id: 44, authId: 49, description: "修改当前用户密码", action: 0},
    <userAuthVO>{id: 45, authId: 50, description: "获取登录用户详细信息", action: 0},
